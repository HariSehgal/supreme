    ...
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg bg-[#E4002B] text-white font-medium shadow-md hover:bg-[#c60025]"
        >
          Submit Report
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {["info", "gratification", "report", "period", "status", "leaderboard"].map((item) => (
          <button
            key={item}
            className={`p-4 border rounded-lg text-center shadow-sm font-medium
              ${activeTab === item ? "bg-[#E4002B] text-white" : "hover:shadow-md"}`}
