...
const ScheduleUnscheduleTask = () => {
    ...
    const fetchVisits = async (pair) => {
        try {
            ...
            const res = await fetch(
                `https://supreme-419p.onrender.com/api/admin/campaign/${selectedCampaign.value}/visit-schedules`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const createVisit = async () => {
        try {
            ...
            const res = await fetch(
                "https://supreme-419p.onrender.com/api/admin/visit-schedule/assign",
                {
                    method: "POST",
                    headers: {
    ...
    const updateVisit = async () => {
        try {
            ...
            const res = await fetch(
                `https://supreme-419p.onrender.com/api/admin/visit-schedule/update/${editingId}`,
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const deleteVisit = async (id) => {
        try {
            ...
            const res = await fetch(
                `https://supreme-419p.onrender.com/api/admin/visit-schedule/delete/${id}`,
                {
                    method: "DELETE",
                    headers: { Authorization: `Bearer ${token}` },
                }
